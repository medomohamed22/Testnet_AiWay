...
export default async function handler(req,res){
  ...
  try{
    ...
    return json(res,200,{
      ...
      finance:{pendingPayments:pending,failedPayments,topSpenders:usersTable.slice().sort((a,b)=>b.paidUsd-a.paidUsd).slice(0,10),totalBalances:remainingUserTokens,providerSharePercent,ownerProfitPercent,openRouterReserveFromSalesUsd,ownerGrossProfitFromSalesUsd,openRouterRequiredForBalancesUsd,openRouterAvailableUsd,openRouterTopUpRequiredUsd,openRouterCoveragePercent},
